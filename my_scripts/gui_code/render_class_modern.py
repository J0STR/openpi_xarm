...
class GuiHandler:
    def __init__(self, width: int, height: int):
        ...
        self.x_reset_button = int((self.x_pixel/2) + self.x_pixel*0.0025 )
        ...
        # Play/Pause button        
        self.x_play_button_box = int((self.x_pixel/2) - self.width_reset_button - int(self.x_pixel*0.0025))
